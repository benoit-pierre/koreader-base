...
require("ffi").cdef[[
// cdecl_const_EAGAIN
static const unsigned EAGAIN = 35;
// cdecl_const_EINTR
...
// cdecl_const_O_TRUNC
static const unsigned O_TRUNC = 1024;
...
static const unsigned PTHREAD_CREATE_DETACHED = 2;
// cdecl_struct__opaque_pthread_attr_t
...
static const unsigned HAVE_POSIX_FALLOCATE = 0;
// cdecl_type_FILE
...
static const unsigned MAP_ANONYMOUS = 4096;
...
static const unsigned TCIFLUSH = 1;
// cdecl_func_tcdrain
int tcdrain(int);
// cdecl_func_tcflush
int tcflush(int, int);
