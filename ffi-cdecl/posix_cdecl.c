...
cdecl_type_replace(__kernel_ino_t, ino_t);
...
cdecl_type_replace(__darwin_gid_t, gid_t);
cdecl_type_replace(__darwin_id_t, id_t);
cdecl_type_replace(__darwin_ino64_t, ino_t);
...
cdecl_type(__darwin_dev_t);
cdecl_type(__darwin_gid_t);
